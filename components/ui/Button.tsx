...
export default function Button({
  ...
  const baseStyles =
    'font-semibold rounded-lg transition-all duration-fast ease-smooth focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed active:scale-98 flex items-center justify-center gap-2';
